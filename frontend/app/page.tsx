...
export default function Home() {
  ...
  const loadCity = useCallback(async () => {
    try {
      ...
      fetch(`${API_BASE}/api/supply-chain`)
  ...
  return (
    <main className="flex h-screen flex-col overflow-hidden bg-[var(--ip-grey-950)]">
      <header className="flex items-start justify-between border-b border-[var(--ip-grey-700)] px-6 py-3.5">
        <div>
          <div className="flex items-baseline gap-2.5">
            <h1 className="text-[19px] font-semibold tracking-tight text-neutral-50">
              InfraPilot
            </h1>
            <span className="font-mono text-[10px] tracking-[0.14em] text-[var(--ip-blue)] uppercase">
              AI resilience copilot
            </span>
          </div>
      ...
      <div className="border-b border-[var(--ip-grey-700)] bg-[var(--ip-grey-900)]/40 px-6 py-3">
        <ScenarioLauncher
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <aside className="flex w-[400px] shrink-0 flex-col gap-3 overflow-y-auto border-l border-[var(--ip-grey-700)] p-3">
          ...
          <div className="h-[204px] shrink-0">
            <ReasoningStream events={sim.events} running={sim.running} error={sim.error} />
          </div>
          ...
          {recommendations.length > 0 && (
            <div className="space-y-2">
              <h3 className="font-mono text-[10px] tracking-[0.14em] text-neutral-400 uppercase">
      ...
      <footer className="flex items-center gap-2 border-t border-[var(--ip-grey-700)] bg-[var(--ip-grey-900)] px-6 py-2">
